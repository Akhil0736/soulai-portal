package com.soulai.portal.events

import android.util.Log
import com.soulai.portal.events.model.EventType
import com.soulai.portal.events.model.PortalEvent
import org.java_websocket.WebSocket
import org.java_websocket.handshake.ClientHandshake
import org.java_websocket.server.WebSocketServer
import java.net.InetSocketAddress
import java.nio.ByteBuffer
import com.soulai.portal.service.ActionDispatcher
    ...
    override fun onMessage(conn: WebSocket?, message: String?) {
        ...
        try {
            ...
            if (id != null && method.isNotEmpty()) {
                    ...
                    installExecutor.submit {
                        try {
                            ...
                            try {
                                if (conn?.isOpen == true) {
                                    conn.send(
                                        com.soulai.portal.api.ApiResponse.Error(
                ...
                if (result is com.soulai.portal.api.ApiResponse.Binary) {
