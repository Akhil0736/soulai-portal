package com.soulai.portal.ui.settings
...
import com.soulai.portal.databinding.SheetSettingsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.switchReverseEnabled.setOnCheckedChangeListener { _, isChecked ->
            ...
            val intent = android.content.Intent(
                requireContext(),
                com.soulai.portal.service.ReverseConnectionService::class.java,
            )
            if (isChecked) {
