package com.soulai.portal.ui

import com.soulai.portal.config.ConfigManager
import com.soulai.portal.service.SoulAIAccessibilityService
import com.soulai.portal.service.SoulAINotificationListener
...
import com.soulai.portal.databinding.ActivityMainBinding
import com.soulai.portal.ui.settings.SettingsBottomSheet
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnResetOffset.setOnClickListener {
            val accessibilityService = SoulAIAccessibilityService.getInstance()
    ...
    private fun applyInputOffset() {
        try {
            ...
            Log.e("SOULAI_MAIN", "Error applying input offset: ${e.message}")
    ...
    private fun updateOverlayOffset(offsetValue: Int) {
        try {
            ...
            if (accessibilityService != null) {
                ...
                if (success) {
                    Log.d("SOULAI_MAIN", "Offset updated successfully: $offsetValue")
                } else {
                    Log.e("SOULAI_MAIN", "Failed to update offset: $offsetValue")
                }
            } else {
                Log.e("SOULAI_MAIN", "Accessibility service not available for offset update")
            }
        } catch (e: Exception) {
            Log.e("SOULAI_MAIN", "Error updating offset: ${e.message}")
        }
    }
    ...
    private fun fetchElementData() {
        try {
            ...
            val uri = Uri.parse("content://com.soulai.portal/state")
            ...
            Log.e("SOULAI_MAIN", "Error fetching combined state data: ${e.message}")
    ...
    private fun toggleOverlayVisibility(visible: Boolean) {
        try {
            ...
            if (accessibilityService != null) {
                ...
                if (success) {
                    Log.d("SOULAI_MAIN", "Overlay visibility toggled to: $visible")
                } else {
                    Log.e("SOULAI_MAIN", "Failed to toggle overlay visibility")
                }
            } else {
                Log.e("SOULAI_MAIN", "Accessibility service not available for overlay toggle")
            }
        } catch (e: Exception) {
            Log.e("SOULAI_MAIN", "Error toggling overlay: ${e.message}")
        }
    }
    ...
    private fun fetchPhoneStateData() {
        try {
            ...
            val uri = "content://com.soulai.portal/".toUri()
            ...
            Log.e("SOULAI_MAIN", "Error fetching phone state: ${e.message}")
    ...
    private fun isAccessibilityServiceEnabled(): Boolean {
        val accessibilityServiceName =
            packageName + "/" + SoulAIAccessibilityService::class.java.canonicalName
        ...
        try {
            ...
            Log.e("SOULAI_MAIN", "Error checking accessibility status: ${e.message}")
            return false
        }
    }
    ...
    private fun isNotificationServiceEnabled(): Boolean {
        val componentName = ComponentName(this, SoulAINotificationListener::class.java)
    ...
    private fun openAccessibilitySettings() {
        try {
            ...
            Toast.makeText(
                this,
                "Please enable Soul AI Portal in Accessibility Services",
                Toast.LENGTH_LONG
            ).show()
        } catch (e: Exception) {
            Log.e("SOULAI_MAIN", "Error opening accessibility settings: ${e.message}")
            Toast.makeText(
                this,
    ...
    private fun openNotificationSettings() {
        try {
            ...
            Toast.makeText(
                this,
                "Please grant Notification Access to Soul AI Portal",
                Toast.LENGTH_LONG
            ).show()
        } catch (e: Exception) {
            Log.e("SOULAI_MAIN", "Error opening notification settings: ${e.message}")
    ...
    private fun updateSocketServerPort(port: Int) {
        try {
            ...
            Log.d("SOULAI_MAIN", "Socket server port updated: $port")
        } catch (e: Exception) {
            Log.e("SOULAI_MAIN", "Error updating socket server port: ${e.message}")
        }
    }
    ...
    private fun updateSocketServerStatus() {
        try {
            ...
            Log.e("SOULAI_MAIN", "Error updating socket server status: ${e.message}")
    ...
    private fun updateAdbForwardCommand() {
        try {
            ...
            Log.e("SOULAI_MAIN", "Error updating ADB forward command: ${e.message}")
    ...
    private fun setAppVersion() {
        try {
            ...
            Log.e("SOULAI_MAIN", "Error getting app version: ${e.message}")
    ...
    private fun showLogsDialog() {
        try {
            ...
            Log.e("SOULAI_MAIN", "Error showing logs dialog: ${e.message}")
