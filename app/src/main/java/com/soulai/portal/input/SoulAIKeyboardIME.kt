package com.soulai.portal.input

import com.soulai.portal.R
...
class SoulAIKeyboardIME : InputMethodService() {
    private val TAG = "SoulAIKeyboardIME"

    companion object {
        private var instance: SoulAIKeyboardIME? = null
        
        fun getInstance(): SoulAIKeyboardIME? = instance
        
        /**
         * Check if the SoulAIKeyboardIME is currently active and available
         */
    ...
    override fun onCreate() {
        super.onCreate()
        instance = this
        Log.d(TAG, "SoulAIKeyboardIME: onCreate() called")
    }
    ...
    override fun onDestroy() {
        Log.d(TAG, "SoulAIKeyboardIME: onDestroy() called")
        instance = null
        super.onDestroy()
    }
}
