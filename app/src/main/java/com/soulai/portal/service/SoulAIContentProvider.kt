...
import com.soulai.portal.api.ApiResponse
...
class SoulAIContentProvider : ContentProvider() {
    companion object {
        private const val TAG = "SoulAIContentProvider"
        private const val AUTHORITY = "com.soulai.portal"
    ...
    override fun onCreate(): Boolean {
        ...
        return if (appContext != null) {
            ...
            Log.d(TAG, "SoulAIContentProvider created")
            true
        } else {
    ...
    private fun getHandler(): ApiHandler? {
        ...
        if (service != null && context != null) {
            apiHandler = ApiHandler(
                ...
                getKeyboardIME = { SoulAIKeyboardIME.getInstance() },
